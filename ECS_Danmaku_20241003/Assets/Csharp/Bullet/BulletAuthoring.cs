...
public class BulletAuthoring : MonoBehaviour
{
    ...
    public class Baker : Baker<BulletAuthoring>
    {
        public override void Bake(BulletAuthoring src)
        {
            ...
            // 残り貫通回数が下限ではなかった
            if (src._remainingPierceCount != UNLIMITED_PIERCE_MINIMUM)
            {
                // 残り貫通回数のDataをアタッチ
            ...
            // 陣営とカテゴリのTagをアタッチ
            AddComponent(entity, GetCampsTagType(src._campsType));
            AddComponent(entity, GetCategoryTagType(src._entityCategory));
        }
    }
}
